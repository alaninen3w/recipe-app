package raze.springboot.recipeapp.bootstrap;
...
import raze.springboot.recipeapp.repositories.CategoryRepository;
...
public class DataLoader implements CommandLineRunner {
    ...
    private Set<Recipe> loadRecipes(){
//        loadUomAndCategories();
    ...
    private void loadUomAndCategories(){
        ...
        unitOfMeasureSet.addAll(Arrays.asList(uom1,uom2,uom3,uom4,uom5));
        unitOfMeasureRepository.saveAll(unitOfMeasureSet);

        Category category1 = Category.builder().description("American").build();
        Category category2 = Category.builder().description("Italian").build();
        Category category3 = Category.builder().description("Mexican").build();
        Category category4 = Category.builder().description("Fast Food").build();
        Set<Category> categorySet = new HashSet<>();
        categorySet.addAll(Arrays.asList(category1,category2,category3,category4));
